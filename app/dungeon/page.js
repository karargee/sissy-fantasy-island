...
const PACKAGES = [
  {
    ...
    includes: ["Full dungeon setup at your location","Restraint system — cuffs, rope, spreader bar","Blindfold & sensory deprivation kit","Paddle, crop & flogger selection","Discreet unmarked vehicle","Setup & teardown included","1 professional Dom/Mistress"],
  },
  {
  ...
  {
    name: "The Takeover", tag: "PREMIUM", duration: "Full Day — 8 Hours", price: 1500, accent: "#7c3aed",
...
const EQUIPMENT = [
  { icon: "⛓", name: "Restraints", desc: "Leather cuffs, rope, spreader bars, hog-tie kits" },
  { icon: "🪑", name: "Furniture", desc: "Bondage bench, St. Andrew's Cross, spanking horse" },
  { icon: "🎭", name: "Sensory", desc: "Blindfolds, hoods, gags, sensory deprivation gear" },
  { icon: "🏹", name: "Impact Play", desc: "Paddles, crops, floggers, canes, single-tail whips" },
  { icon: "🔒", name: "Chastity", desc: "Cages, locks, denial devices for all levels" },
  { icon: "💄", name: "Sissy Station", desc: "Wigs, makeup, outfits, heels, corsets, accessories" },
  { icon: "⚡", name: "Electro Play", desc: "TENS units, violet wands — Takeover only" },
...
function BookingForm({ pkg: initPkg }) {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "0.85rem" }}>
      ...
      <p style={{ fontSize: "0.7rem", color: "rgba(255,255,255,0.25)", lineHeight: 1.6 }}>🔒 All information is strictly confidential. NDAs available on request.</p>
...
export default function DungeonPage() {
  ...
  const [selPkg, setSelPkg] = useState("The Session");
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#080608", color: "#f0f0f0" }}>
      ...
      {/* NAV */}
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 200, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "1.1rem 2rem", background: "rgba(8,6,8,0.95)", backdropFilter: "blur(24px)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
        <Link href="/" style={{ color: "#f5a9b8", textDecoration: "none", fontWeight: 900, fontSize: "0.9rem", letterSpacing: 3, textTransform: "uppercase" }}>SFI 💕</Link>
        <div style={{ display: "flex", gap: "2rem", alignItems: "center" }}>
          {[["#packages","Packages"],["#equipment","Equipment"],["#faq","FAQ"]].map(([href, txt]) => (
            <a key={href} href={href} style={{ color: "rgba(255,255,255,0.45)", textDecoration: "none", fontSize: "0.8rem", letterSpacing: 1, textTransform: "uppercase" }}>{txt}</a>
          ))}
      ...
      <div style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", paddingTop: 60 }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "url('https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1800&q=80')", backgroundSize: "cover", backgroundPosition: "center", opacity: 0.2 }} />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, rgba(8,6,8,0.5) 0%, rgba(8,6,8,0.75) 60%, #080608 100%)" }} />
        ...
        <div style={{ position: "relative", zIndex: 2, textAlign: "center", padding: "0 1.5rem", maxWidth: 860 }}>
          <div style={{ display: "inline-block", fontSize: "0.62rem", fontWeight: 700, letterSpacing: 4, textTransform: "uppercase", color: gold, borderBottom: `1px solid ${gold}55`, paddingBottom: "0.5rem", marginBottom: "2rem" }}>
            Mobile BDSM Dungeon — Las Vegas & Nationwide
          </div>
          <h1 style={{ fontSize: "clamp(3.2rem, 9vw, 7rem)", fontWeight: 900, letterSpacing: -4, lineHeight: 0.92, marginBottom: "2rem", color: "#fff" }}>
            THE DUNGEON<br />
          ...
          <p style={{ color: "rgba(255,255,255,0.5)", maxWidth: 540, margin: "0 auto 3rem", lineHeight: 1.9, fontSize: "1.05rem", fontWeight: 300 }}>
          ...
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap", marginBottom: "4rem" }}>
            ...
            <a href="#packages" style={{ padding: "1.1rem 3rem", border: `1px solid ${gold}55`, color: gold, textDecoration: "none", fontWeight: 600, fontSize: "0.88rem", textTransform: "uppercase", letterSpacing: 2, borderRadius: 4 }}>View Packages</a>
          </div>
          <div style={{ display: "flex", gap: "3rem", justifyContent: "center", flexWrap: "wrap", borderTop: "1px solid rgba(255,255,255,0.07)", paddingTop: "2.5rem" }}>
      ...
      <div style={{ background: "#0d0a0d", borderTop: "1px solid rgba(255,255,255,0.05)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 1.5rem", display: "flex", justifyContent: "center", flexWrap: "wrap" }}>
          {["🔒 NDA Available","🚑 First-Aid Trained Staff","🧼 Sanitized Between Sessions","📵 No Photos Without Consent","🚚 Unmarked Vehicle"].map(t => (
            <div key={t} style={{ padding: "1.2rem 1.5rem", fontSize: "0.78rem", color: "rgba(255,255,255,0.4)", borderRight: "1px solid rgba(255,255,255,0.05)", whiteSpace: "nowrap" }}>{t}</div>
          ))}
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", height: 280, overflow: "hidden" }}>
        {IMGS.map((src, i) => (
          <div key={i} style={{ position: "relative", overflow: "hidden" }}>
            <img src={src} alt="" style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.55, filter: "grayscale(20%) contrast(1.1)", transition: "transform 0.5s" }}
              onMouseEnter={e => e.currentTarget.style.transform = "scale(1.06)"}
              onMouseLeave={e => e.currentTarget.style.transform = "scale(1)"}
            />
            <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to bottom, transparent 50%, rgba(8,6,8,0.8) 100%)" }} />
          </div>
        ))}
      </div>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "7rem 1.5rem" }}>
        <div style={{ textAlign: "center", marginBottom: "5rem" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.4)", maxWidth: 480, margin: "0 auto", lineHeight: 1.8 }}>From first enquiry to final teardown — seamless, professional, and completely discreet.</p>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1px", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.05)", borderRadius: 4, overflow: "hidden" }}>
          {STEPS.map((s, i) => (
            <div key={s.n} style={{ padding: "2.5rem 2rem", background: "#0a080a", borderBottom: i < 3 ? "1px solid rgba(255,255,255,0.05)" : "none" }}>
              ...
              <h3 style={{ fontSize: "0.95rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: 2, marginBottom: "0.7rem", color: gold }}>{s.title}</h3>
              <p style={{ fontSize: "0.83rem", color: "rgba(255,255,255,0.5)", lineHeight: 1.8 }}>{s.desc}</p>
            </div>
          ))}
        </div>
      </div>
              ...
              <div key={pkg.name} style={{ background: pkg.popular ? "linear-gradient(160deg,#1a0d1a,#120812)" : "#0d0a0d", border: `1px solid ${pkg.popular ? "rgba(214,51,132,0.3)" : "rgba(255,255,255,0.07)"}`, borderRadius: 4, overflow: "hidden", position: "relative" }}>
                ...
                <div style={{ padding: "2.5rem 2rem" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "1.5rem" }}>
                    <span style={{ fontSize: "0.58rem", fontWeight: 700, letterSpacing: 3, textTransform: "uppercase", color: pkg.accent, border: `1px solid ${pkg.accent}44`, padding: "0.25rem 0.7rem", borderRadius: 2 }}>{pkg.tag}</span>
                    <span style={{ fontSize: "0.7rem", color: "rgba(255,255,255,0.3)", letterSpacing: 1 }}>{pkg.duration}</span>
                  </div>
                  <h3 style={{ fontSize: "1.8rem", fontWeight: 900, letterSpacing: -1, marginBottom: "0.5rem" }}>{pkg.name}</h3>
                  <p style={{ fontSize: "0.83rem", color: "rgba(255,255,255,0.45)", lineHeight: 1.7, marginBottom: "1.5rem", fontStyle: "italic" }}>{pkg.desc}</p>
                  <div style={{ fontSize: "3.5rem", fontWeight: 900, letterSpacing: -3, color: pkg.accent, lineHeight: 1, marginBottom: "0.3rem" }}>${pkg.price.toLocaleString()}</div>
                  <div style={{ fontSize: "0.68rem", color: "rgba(255,255,255,0.25)", marginBottom: "2rem", letterSpacing: 1, textTransform: "uppercase" }}>One-time · No hidden fees</div>
                  <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: "1.5rem", display: "flex", flexDirection: "column", gap: "0.7rem", marginBottom: "2rem" }}>
                    {pkg.includes.map(item => (
                      <div key={item} style={{ display: "flex", gap: "0.8rem", alignItems: "flex-start", fontSize: "0.82rem", color: "rgba(255,255,255,0.6)", lineHeight: 1.5 }}>
                        <div style={{ width: 14, height: 14, borderRadius: "50%", background: `${pkg.accent}22`, border: `1px solid ${pkg.accent}55`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: 2 }}>
                          <div style={{ width: 4, height: 4, borderRadius: "50%", background: pkg.accent }} />
                        </div>
                        {item}
                      </div>
                    ))}
                  </div>
                  <a href="#book" onClick={() => setSelPkg(pkg.name)} style={{ display: "block", textAlign: "center", padding: "1rem", background: pkg.popular ? "linear-gradient(135deg,#d63384,#7c3aed)" : "transparent", border: pkg.popular ? "none" : `1px solid ${pkg.accent}55`, color: pkg.popular ? "white" : pkg.accent, textDecoration: "none", fontWeight: 700, fontSize: "0.8rem", letterSpacing: 2, textTransform: "uppercase", borderRadius: 4 }}>
                    Book This Package
                  </a>
                </div>
              </div>
      ...
      <div id="equipment" style={{ maxWidth: 1100, margin: "0 auto", padding: "7rem 1.5rem" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
          <div>
            ...
            <p style={{ color: "rgba(255,255,255,0.45)", lineHeight: 1.9, marginBottom: "2.5rem", fontSize: "0.95rem" }}>
            ...
            <div style={{ display: "flex", gap: "2.5rem" }}>
              {[["50+","Equipment Pieces"],["100%","Sanitized"],["0","Visible Branding"]].map(([v,l]) => (
                <div key={l}>
                  <div style={{ fontSize: "1.8rem", fontWeight: 900, color: gold, letterSpacing: -1 }}>{v}</div>
                  <div style={{ fontSize: "0.62rem", color: "rgba(255,255,255,0.3)", textTransform: "uppercase", letterSpacing: 1.5, marginTop: "0.2rem" }}>{l}</div>
                </div>
              ))}
            </div>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1px", background: "rgba(255,255,255,0.05)", borderRadius: 4, overflow: "hidden" }}>
            {EQUIPMENT.map(item => (
              <div key={item.name} style={{ background: "#0a080a", padding: "1.5rem", transition: "background 0.2s" }}
                onMouseEnter={e => e.currentTarget.style.background = "#130d13"}
      ...
      <div id="book" style={{ background: "#0a080a", borderTop: "1px solid rgba(255,255,255,0.05)", padding: "7rem 0" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 1.5rem", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "start" }}>
          <div>
            <span style={label}>Reservations</span>
            ...
            <p style={{ color: "rgba(255,255,255,0.4)", lineHeight: 1.8, marginBottom: "2rem", fontSize: "0.9rem" }}>Fill out the form and we'll confirm within 2 hours. All details are strictly confidential.</p>
            <div style={{ background: "#0d0a0d", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 4, padding: "2rem" }}>
              <BookingForm pkg={selPkg} />
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.7rem", marginTop: "1.5rem" }}>
              {[["📧","mailto:sissyfantasyisland70@gmail.com","sissyfantasyisland70@gmail.com"],["📞","tel:+14153053689","(415) 305-3689"],["💬","https://wa.me/14153053689","WhatsApp"]].map(([icon,href,txt]) => (
                <a key={txt} href={href} target={href.startsWith("http") ? "_blank" : undefined} rel="noopener" style={{ display: "flex", alignItems: "center", gap: "0.8rem", color: "rgba(255,255,255,0.45)", textDecoration: "none", fontSize: "0.82rem" }}>
                  <span style={{ width: 32, height: 32, borderRadius: "50%", background: "rgba(255,255,255,0.05)", display: "flex", alignItems: "center", justifyContent: "center" }}>{icon}</span>
                  {txt}
                </a>
              ))}
            </div>
          ...
          <div>
            <span style={label}>Client Reviews</span>
            <h2 style={{ fontSize: "clamp(1.8rem, 3vw, 2.4rem)", fontWeight: 900, letterSpacing: -2, marginBottom: "2.5rem", lineHeight: 1.1 }}>What Our Clients Say</h2>
              ...
              {TESTIMONIALS.map((t, i) => (
                <div key={i} style={{ padding: "1.8rem", background: "#0d0a0d", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 4 }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: "1rem" }}>
                    ...
                    <span style={{ fontSize: "0.62rem", color: gold, border: `1px solid ${gold}44`, padding: "0.2rem 0.6rem", borderRadius: 2, letterSpacing: 1, textTransform: "uppercase" }}>{t.pkg}</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        {FAQS.map((f, i) => (
          <div key={i} style={{ borderBottom: "1px solid rgba(255,255,255,0.07)", cursor: "pointer" }} onClick={() => setOpenFaq(openFaq === i ? null : i)}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "1.4rem 0", gap: "1rem" }}>
              <span style={{ fontWeight: 600, fontSize: "0.95rem", color: openFaq === i ? "#fff" : "rgba(255,255,255,0.7)" }}>{f.q}</span>
              <span style={{ color: gold, fontSize: "1.3rem", flexShrink: 0, fontWeight: 300, transition: "transform 0.2s", transform: openFaq === i ? "rotate(45deg)" : "none" }}>+</span>
            </div>
            {openFaq === i && <div style={{ paddingBottom: "1.4rem", fontSize: "0.87rem", color: "rgba(255,255,255,0.5)", lineHeight: 1.9 }}>{f.a}</div>}
          </div>
        ))}
      </div>
      ...
      <div style={{ position: "relative", overflow: "hidden", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "url('https://images.unsplash.com/photo-1604881991720-f91add269bed?w=1800&q=80')", backgroundSize: "cover", backgroundPosition: "center", opacity: 0.1 }} />
        <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse at 50% 50%, rgba(214,51,132,0.12) 0%, transparent 70%)" }} />
        <div style={{ position: "relative", zIndex: 2, textAlign: "center", padding: "9rem 1.5rem" }}>
          <span style={{ ...label, display: "block", marginBottom: "1.5rem" }}>Available 7 Days a Week</span>
          <h2 style={{ fontSize: "clamp(3rem, 7vw, 6rem)", fontWeight: 900, letterSpacing: -4, lineHeight: 0.95, marginBottom: "1.5rem" }}>
            READY TO<br />
          ...
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <Link href="/#cards" style={{ padding: "1.1rem 3rem", border: `1px solid ${gold}55`, color: gold, textDecoration: "none", fontWeight: 600, fontSize: "0.88rem", textTransform: "uppercase", letterSpacing: 2, borderRadius: 4 }}>Get Diamond Card</Link>
          </div>
        </div>
      </div>

      {/* FOOTER */}
      <div style={{ background: "#050405", borderTop: "1px solid rgba(255,255,255,0.05)", padding: "2rem 1.5rem", textAlign: "center" }}>
        <p style={{ fontSize: "0.72rem", color: "rgba(255,255,255,0.2)" }}>© 2026 Sissy Fantasy Island · All sessions are private and confidential · 18+ only</p>
      </div>
...
export default function DungeonPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#080608", color: "#f0f0f0" }}>
      ...
      {/* HERO */}
      <div style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", paddingTop: 60 }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "url('https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=1600&q=80')", backgroundSize: "cover", backgroundPosition: "center", opacity: 0.15 }} />
      ...
      <div style={{ background: "#0d0a0d", borderTop: "1px solid rgba(255,255,255,0.05)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 1.5rem", display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "0" }}>
          {["🔒 NDA Available","🚑 First-Aid Trained Staff","🧼 Sanitized Between Sessions","📵 No Photos Without Consent","🚚 Unmarked Vehicle"].map((t, i) => (
      ...
      <div id="book" style={{ background: "#0a080a", borderTop: "1px solid rgba(255,255,255,0.05)", padding: "7rem 0" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 1.5rem", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "start" }}>
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.7rem", marginTop: "1.5rem" }}>
              {[
                { href: "mailto:sissyfantasyisland70@gmail.com", icon: "✉", text: "sissyfantasyisland70@gmail.com" },
                { href: "tel:+14153053689", icon: "📞", text: "(415) 305-3689" },
                { href: "https://wa.me/14153053689", icon: "💬", text: "WhatsApp", target: "_blank" },
              ].map(c => (
        ...
        {FAQS.map((f, i) => (
          <div key={i} style={{ borderBottom: "1px solid rgba(255,255,255,0.07)", cursor: "pointer" }} onClick={() => setOpenFaq(openFaq === i ? null : i)}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "1.4rem 0", gap: "1rem" }}>
              ...
              <span style={{ color: gold, fontSize: "1.3rem", flexShrink: 0, fontWeight: 300 }}>{openFaq === i ? "−" : "+"}</span>
            </div>
      ...
      {/* BOTTOM CTA */}
      <div style={{ position: "relative", overflow: "hidden", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "url('https://images.unsplash.com/photo-1604881991720-f91add269bed?w=1600&q=80')", backgroundSize: "cover", backgroundPosition: "center", opacity: 0.1 }} />
        <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse at 50% 50%, rgba(214,51,132,0.12) 0%, transparent 70%)" }} />
      ...
      <div style={{ background: "#060406", borderTop: "1px solid rgba(255,255,255,0.05)", padding: "2rem 1.5rem", textAlign: "center" }}>
        <p style={{ color: "rgba(255,255,255,0.2)", fontSize: "0.72rem" }}>
          © 2026 Sissy Fantasy Island · <a href="mailto:sissyfantasyisland70@gmail.com" style={{ color: "rgba(255,255,255,0.3)", textDecoration: "none" }}>sissyfantasyisland70@gmail.com</a> · All sessions are private and confidential. 18+ only.
        </p>
      </div>
