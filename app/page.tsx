...
export default function Home() {
  ...
  const videos = [
    '/677f2b7845044f8b.webp',
    '/917db59e89ae9d07.webp', 
    '/75cb3ea7242d5b02.webp',
    '/8f529c75300a9be6.webp',
    '/928881209a442461.webp',
    '/95a16934f7821a27.webp'
  ]
      ...
      <section className="relative min-h-[500px] md:min-h-[600px] lg:min-h-[700px] flex items-center justify-center overflow-hidden">
        ...
        >
          <motion.h1 
            ...
            className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 text-white drop-shadow-2xl"
          >
          ...
          <motion.p 
            ...
            className="text-base md:text-lg lg:text-xl text-white mb-6 md:mb-8 drop-shadow-lg font-medium px-4"
          >
          ...
          >
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-pink-500 text-white px-6 md:px-8 py-3 md:py-4 rounded-lg text-base md:text-lg hover:bg-pink-600 transition-all duration-300 shadow-lg flex items-center gap-2"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            {[
              ...
              <motion.div
                ...
                className="text-center p-4 md:p-6 rounded-lg bg-white/80 backdrop-blur-sm shadow-lg"
              >
                <motion.div 
                  whileHover={{ rotate: 360 }}
                  transition={{ duration: 0.6 }}
                  className="inline-flex items-center justify-center w-10 h-10 md:w-12 md:h-12 bg-pink-100 rounded-full mb-3 md:mb-4"
                >
                  <item.icon className="w-5 h-5 md:w-6 md:h-6 text-pink-500" />
                </motion.div>
      ...
      >
        <div className="container mx-auto px-4">
          <motion.h2 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="text-2xl md:text-4xl font-bold text-center mb-8 md:mb-12 bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent"
          >
            Shop by Category
          </motion.h2>
                  ...
                  >
                    ...
                    <div className="flex gap-2 flex-col sm:flex-row">
                      <motion.button 
                        ...
                        className="flex-1 bg-gradient-to-r from-pink-500 to-purple-500 text-white py-2.5 md:py-3 rounded-lg text-sm md:text-base font-semibold hover:from-pink-600 hover:to-purple-600 transition-all duration-300 flex items-center justify-center gap-2"
                      >
